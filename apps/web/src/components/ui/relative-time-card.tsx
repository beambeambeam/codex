...
const triggerVariants = cva(
  "text-foreground/70 hover:text-foreground/90 focus-visible:ring-ring inline-flex w-fit items-center justify-center text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        default: "",
